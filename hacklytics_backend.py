...
Need to run 'pip install -U -q "google-generativeai>=0.8.2"' and 'pip install pypdf' for program to work
"""
...
fullest extent. Do not add any additional text outside the HTML tags.
